...
class ExtractMarkupTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testMarkupIdentitiesAndClassExtraction() {
        $test2 = new FeatureContext([]);
        $test2->iHaveContent('<a href="sdfsf" id="mu_idee" class="eh">link</a><p id="wtf"></p>');
        $test2->iExtractMarkupClassesAndIdentities();
        $test2->iShouldGet("mu_idee,wtf,eh");
    }
}
